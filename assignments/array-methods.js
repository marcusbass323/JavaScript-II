...
let fullName = []; //fullName is my empty array

runners.forEach(cb); // call cb function for the array elements

function cb(item, index, array) { // pushing first and last names to the new array
...
let allCaps = []; // my empty array

runners.map(cb);

function cb(item, index, array) {
  
  return allCaps.push(`${first_name`);
